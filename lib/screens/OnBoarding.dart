import 'package:final_enactus/screens/BoldTitle.dart';
...
alignment: Alignment.center,
  children: [
    ...
    Center(heightFactor:2.0,widthFactor: 30,
        child:CircleAvatar(backgroundImage: AssetImage("assets/images/carrot_red.png"),radius: 60.0,
    )),
   BoldTitle(),
    // Row(
    //   mainAxisAlignment: MainAxisAlignment.end,
